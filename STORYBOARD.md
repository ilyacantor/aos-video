...
|--------|------|----|-----|------|--------|
| **Title Card** | 0:00 | 0:07 | 7.0s | scene0-mai-intro | "Hi, I'm Mai. I'm the AI agent built into AOS — I'll walk you through the platform." |
...
| **Scene 2 Intro** | 0:23 | 0:36 | 13.4s | scene2-solution | "AOS is the layer that fixes this. It sits on top of everything you already have — no migration, no rip and replace — and gives your whole organization one shared understanding of what's actually going on." |
| **Scene 2** | 0:36 | 1:20 | 44.3s | scene2-discover (@1.5s) | "It starts with discovery. AOS scans your environment and builds a catalog of every system you have — including the ones nobody remembers buying." |
| | | | | scene2-connect (@12.0s) | "Then AOS connects to them. Your systems don't change. Your data doesn't move. Our layer sits on top, using the integration tools you already own — your iPaaS, your APIs, your warehouse." |
| | | | | scene2-resolve (@27.9s) | "Then it figures out what the data actually means. How customers, products, contracts, and accounts relate to each other — automatically, across every source." |
| | | | | scene2-ask (@39.7s) | "And the result is a context layer your whole organization can use." |
| **Scene 3A** | 1:20 | 1:46 | 25.6s | scene3a-mai | "Each AOS deployment ships with me — I'm Mai, your AI agent. I handle onboarding, training, and configuration, and I answer questions about your data in plain English." |
| | | | | scene3a-mai-config (@13s) | "You can also ask me to make changes to the platform. Simple things happen instantly. Bigger changes — like adding a new domain to your org — happen with your approval, and I walk you through it." |
| **Scene 4** | 1:46 | 2:03 | 17.1s | scene4-knowledgegraph | "The thing that makes all of this work is the knowledge graph. It's not a database — it's a living map of your people, your systems, and how they actually relate to each other. That's the context your agents have been missing. And it's what lets them act instead of guess." |
| **Scene 5 Intro** | 2:03 | 2:12 | 9.8s | scene5-intro | "Everything I've shown you so far works for one company. Now let me show you what happens when there are two. The leading use case: M&A." |
| **Scene 5** | 2:12 | 2:56 | 43.0s | scene5-title (@0s) | "M&A runs on an impossible clock. Two companies, two sets of books, two versions of the truth. Convergence turns weeks of diligence into hours. Here's what we automate." |
...
| | | | | scene5-ebitda (@26s) | "Proforma combined earnings, generated in diligence and tracked through close." |
...
| **Scene 6** | 2:56 | 3:07 | 11.5s | scene6-deploy | "And the best part: AOS deploys in days, not quarters. No migration. No rip and replace. Your systems stay exactly where they are." |
| **Scene 7** | 3:07 | 3:17 | 9.9s | scene7-closing | "AOS is built for the reality of enterprise technology — light, fast, secure. If you want to see more, find us at A.O.S. dot tech." |
